...
export class AppComponent {
    ...
    tools: string = 'datetime | save | clear | backcolor | bold italic underline | font size | left center right | outdent indent';
    btnOnClick(): void {
        this.myWindow.open();
    }
            ...
            case 'datetime':
                return {
                    ...
                    init: (widget: any): void => {
                        widget.jqxDropDownList({ placeHolder: 'Insert Custom HTML',
                         width: 170, source: ['Insert Time', 'Insert Date'], autoDropDownHeight: true });
                    },
                    ...
                    action: (widget: any, editor: any): any => {
                        ...
                        return { command: 'inserthtml', value: widgetValue === 'Insert Time' ? date.getHours()
            ...
            case 'save':
                return {
                    ...
                    init: (widget: any): void => {
                        ...
                        widget.html('<span style="line-height: 24px;">Save</span>');
                    },
                    refresh: (widget: any, style: any): void => {
                        // do something here when the selection is changed.
                    },
